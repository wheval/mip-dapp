...
export function AssetFilterDrawer({
  filters = {
    search: "",
    assetTypes: [],
    licenses: [],
      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            ...
            <DrawerDescription>Discover IP assets that match your interests</DrawerDescription>
          </DrawerHeader>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <div className={`w-6 h-6 rounded-md flex items-center justify-center ${type.color}`}>
