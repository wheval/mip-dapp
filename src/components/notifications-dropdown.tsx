...
const mockNotifications: Notification[] = [
  {
    id: "1",
    type: "success",
    title: "Welcome to MIP",
    message: "Let's get started with your first asset",
    time: "1 minutes ago",
    read: false,
  },
  {
    id: "2",
    type: "activity",
    title: "Fast, Secure and Free",
    message: "Protect your intellectual property with MIP dapp",
    time: "2 minutes ago",
    read: false,
  },
  {
    id: "3",
    type: "info",
    title: "Powered on Starknet",
    message: "High performance, zero knowledge and endless possibilities",
    time: "3 minutes ago",
    read: true,
  },
]
