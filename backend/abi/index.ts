export const abi = [
  {
    type: "impl",
    name: "MIPImpl",
    interface_name: "ip_programmable_erc_721::MIP::IMIP",
  },
  {
    type: "struct",
  ...
  {
    type: "interface",
    name: "ip_programmable_erc_721::MIP::IMIP",
    items: [
      {
        type: "function",
        name: "mint_item",
  ...
  },
  {
    type: "impl",
    name: "CounterImpl",
    interface_name: "ip_programmable_erc_721::components::Counter::ICounter",
  },
  {
    type: "interface",
    name: "ip_programmable_erc_721::components::Counter::ICounter",
    items: [
      {
        type: "function",
        name: "current",
  ...
  {
    type: "event",
    name: "ip_programmable_erc_721::components::Counter::CounterComponent::Event",
    kind: "enum",
    variants: [],
  },
  {
  ...
  {
    type: "event",
    name: "ip_programmable_erc_721::MIP::MIP::Event",
    kind: "enum",
    variants: [
      {
        name: "ERC721Event",
      ...
      {
        name: "CounterEvent",
        type: "ip_programmable_erc_721::components::Counter::CounterComponent::Event",
        kind: "nested",
      },
      {
